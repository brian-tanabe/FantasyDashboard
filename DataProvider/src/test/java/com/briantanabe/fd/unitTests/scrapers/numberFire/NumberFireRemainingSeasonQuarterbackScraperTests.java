...
public class NumberFireRemainingSeasonQuarterbackScraperTests {
    ...
    public static void setup(){
        Document numberFireRemainingYearProjectionsDocument = getDocumentFromFileHtml("./DataProvider/src/test/resources/WebPages/nfRemainingSeasonQbProjections.html");
